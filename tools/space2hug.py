...
if __name__ == '__main__':
    ...
    for num in range(5, 13):
        input_pytorch = os.path.join('/data_hdd/myself/TRACE/outputs/pre_train/convbert-super-248-0-drop0.2-mlm0.1-tem0.07-ppt5-epoch60-lr1e-5-user-dstc2,dstc3,incar,MultiWOZ2.2_few,multiwoz_synthesis,SGD,taskmaster1,taskmaster2,taskmaster3,woz-seed11',
                                     f'state_epoch_{num}.model')

        output_dir = f'/home/myself/dialoglue/trippy/model/super-few-multiwoz-{num}'
