...
#LOAD_MODEL_DIR=convbert-super-128-0-drop0.2-mlm0.1-tem0.07-ppt5-epoch60-lr1e-5-user-banking,clinc,hwu-seed11
LOAD_MODEL_NAME=state_epoch_8
LOAD_MODEL_DIR=convbert-super-160-0-drop0.2-mlm0.1-tem0.07-ppt5-epoch20-lr1e-5-user--seed11
INIT_CHECKPOINT=${SAVE_ROOT}/outputs/pre_train/${LOAD_MODEL_DIR}/${LOAD_MODEL_NAME}
EXAMPLE=false
